...
public interface EquipmentRepository extends JpaRepository<Equipment, UUID>{
    ...
    List<Equipment> findByCategory_categoryID(UUID category_id);
    ...
    List<Equipment> findByStorageID(UUID storage_id);

    //List<Equipment> findByEquipmentsOnStorage_Storage_Storage_id(@Nullable UUID storage_id);

    List<Equipment> findByEquipmentsOnStorage_Storage_StorageID(@Nullable UUID storage_id);
